...
function PlaygroundHero() {
  return (
    <section
      className="relative flex min-h-[560px] w-full items-center"
      style={{
    ...
    >
      <div
        className="relative z-10 mx-auto w-full max-w-4xl px-6 py-24 md:py-32"
      ...
      >
        ...
        <h1
          className="mb-6 text-6xl font-medium tracking-tight md:text-7xl"
          style={{ color: '#F3EAD7' }}
        >
        ...
        <div className="flex flex-col gap-4 sm:flex-row">
          <a
            href="#projects"
            className="inline-flex items-center gap-2 rounded border px-6 py-3 text-sm font-medium transition-all hover:-translate-y-0.5"
            style={{
              borderColor: '#1F2A45',
